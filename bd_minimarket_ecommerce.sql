...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2024 a las 22:54:11
...
--
-- Base de datos: `bd_minimarket_ecommerce`
--
...
(7, 'Lima', 'Calle los manzanos 9135', 'Ferreñafe', 'Roberto Angel', '7368159', 'Ferreñafe', 'DNI', 23, 'Cuchula', 'Balbin', '995662847');
...
(23, b'0', 'A', '.jpeg', '09f357e1-cc5f-4b25-a71f-cd0ce3219a5b', 'profilePh219202422331');
...
(1, b'0', '2024-07-19 15:51:22', 48, 1),
(2, b'0', '2024-07-23 22:28:53', 12, 1),
(3, b'0', '2024-08-12 02:04:35', 38, 1),
(4, b'0', '2024-08-21 17:37:49', 62, 7),
(5, b'0', '2024-08-21 17:53:24', 43, 7),
(6, b'1', '2024-08-21 20:45:57', 60, 7);
...
(1, 'Es un sabroso plato muy popular en Perú que se prepara con arroz frito, diversas carnes, verduras y salsa de soja. Posiblemente es uno de los platos más consumidos en la gastronomía peruana por su fácil elaboración y su rico sabor. Hay muchas variedades ya que puede prepararse con pollo, carne de ternera, huevo o salchicha.', 'Arroz Chaufa', 15, 54, b'1', 2, 10, b'1'),
(2, 'El arroz con pollo es un plato típico de América Latina y España 1​ con variaciones regionales según el país. Consiste en arroz cocinado con pollo, en presas o desmechado, verduras (ají pimentón, zanahoria en cubos, apio, habichuelas, cebolla, maíz desgranado, aceitunas, arvejas, alcaparras), y sazonado con especias (laurel, tomillo, cilantro, ajo)', 'Arroz con Pollo', 20, 51, b'1', 2, 15, b'1'),
(3, 'Los Tallarines rojos con pollo es un plato de fondo que se come mucho en el Perú. Este plato es una fusión de la comida peruana e italiana, ya que se origina en el spaghetti ala bolognese.', 'Tallarines Rojos', 6, 53, b'1', 1, 16, b'1'),
(4, 'Una de las comidas de la costar que suele acompañar los platos de carne, se tratan de unos tallarines a base de leche evaporada, espinaca, nueces pecanas, albahaca y parmesano. Todos estos ingredientes forman la característica salsa verde.', 'Tallarines Verdes', 12, 44, b'1', 1, 21, b'1'),
(5, 'Como su nombre indica, el arroz con pato es un plato de arroz, picante y ácido, cuyos ingredientes principales son el pato, macerado en ajo y vinagre, ají amarillo que le da el picor y un arroz verdoso gracias al culantro que se añade.​ Es común añadir en la cocción una cantidad al gusto de cerveza negra o de chicha de jora.​ Se sirve acompañado con salsa criolla. Existen variantes que remplazan el culantro por palillo, para darle un color amarillo.', 'Arroz con Pato', 25, 49, b'1', 2, 1, b'1'),
(6, 'El siguiente plato se sirve con una base de arroz blanco y papas, se prepara un sofrito con ají amarillo, ajo, pan, cebolla y parmesano, se le añade la gallina hervida desmenuzada y nueces molidas. Listo para servir.', 'Ají de Gallina', 18, 49, b'1', 2, 13, b'1'),
...
(7, 'angel123', 'angelbalbin555@gmail.com', b'1', 7);
